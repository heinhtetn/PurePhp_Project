        ...
        <div class="row p-5">
            ...
            <div class="col-12 col-md-4 col-lg-4">
                <div class="d-flex">
                    ...
                    <select class="form-select" id="item_select" name="item_name">
                        <option <?= get_select('item_name', '') ?> value="">Inventory</option>
                        <?php foreach ($inven_list as $item) : ?>
                            <option value="<?= $item->item_name ?>" data-item-id="<?=$item->item_id?>"><?= $item->item_name ?></option>
                        <?php endforeach; ?>
                    </select>
