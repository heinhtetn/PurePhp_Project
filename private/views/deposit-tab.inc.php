    ...
    <form action="" method="post" id="depositForm">
        <div class="rounded mx-auto my-5 border" style="width: 100%; max-width: 350px;">
            <div style="padding: 20px;">
                <h2 class="text-center mb-5" style="font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;">Deposit</h2>
                ...
                <button class="btn btn-dark float-end" id="depositButton" type="submit">Deposit</button>
            </div>
        </div>
    </form>
</div>